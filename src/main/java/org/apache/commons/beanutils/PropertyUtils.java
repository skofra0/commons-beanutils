...
public class PropertyUtils {
  ...
  @Deprecated
  public static ConcurrentHashMap getMappedPropertyDescriptors(final Class<?> beanClass) {
   ...
   * @deprecated This method should not be exposed */
  @Deprecated
  public static ConcurrentHashMap getMappedPropertyDescriptors(final Object bean) {
